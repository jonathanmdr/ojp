...
public class Db2ResultSetMetaDataExtensiveTests {
    ...
    public void testDb2SpecificDataTypes(String driverClass, String url, String user, String password) throws SQLException {
        ...
        try {
            statement.execute("DROP TABLE TEST_DB2_TYPES");
        } catch (Exception e) {
            // Might not be created.
        }
        ...
        statement.execute("INSERT INTO TEST_DB2_TYPES (bigint_col, smallint_col, real_col, double_col, char_col, varchar_col, clob_col, blob_col, date_col, time_col, timestamp_col, boolean_col) " +
        ...
        ResultSet resultSet = statement.executeQuery("SELECT * FROM TEST_DB2_TYPES");
